	...
	<script type="text/html" id="post_list">
		{{each postlist as value i}}
			<li>
              ...
              <i>发帖时间 {{value.releasetime}}</i>
				<a class="mine-edit" href="${ pageContext.request.contextPath }/go/add?artid={{value.id}}">编辑</a>
       ...
       <script type="text/html" id="coll_list">
		{{each colllist as value2 i}}
			<li>
              <a class="jie-title" href="${pageContext.request.contextPath}/article/detail/{{value2.articleid}}" target="_blank">{{value2.title}}</a>
