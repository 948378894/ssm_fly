  ...
  <div class="main">
    ...
    <div class="nav">
      ...
      <a href="http://www.layui.com/" target="_blank">
       ...
       <a href="${pageContext.request.contextPath}/article/rili" target="_blank">
        <i class="iconfont icon-ui"></i>签到系统
      </a>
    </div>
...
<div class="fly-home" style="background-image: url();">
  ...
  <p class="fly-home-sign">${login_user.sign}</p>
</div>
...
<div class="main fly-home-main">
  <div class="layui-inline fly-home-jie">
    <div class="fly-panel">
      ...
      <script type="text/html" id="post_model">
		{{each postlist as value i}}
			<li>
			{{if value.cream==1}}
				<span class="fly-jing">精</span>
			{{/if}}
              <a class="jie-title" href="${pageContext.request.contextPath}/article/detail/{{value.id}}" target="_blank">{{value.title}}</a>
				<i>{{value.releasetime}}天前</i>
              <em>{{value.visitnum}}阅/{{value.commentnum}}答</em>
				
            </li>
			<div>{{value.markdown_content}}</div></br>
		{{/each}}
       </script>
...
<!-- <div class="fly-none" style="min-height: 50px; padding:30px 0; height:auto;"><i style="font-size:14px;">没有发表任何求解</i></div> -->
  ...
  <div class="layui-inline fly-home-da">
    <div class="fly-panel">
      <h3 class="fly-panel-title">${login_user.nickname} 最近的回答</h3>
...
full: true         
       ...
       <script type="text/html" id="comm_model">
		{{each commlist as value i}}
			<li>
          <p>
          <span>{{value.commtime}}</span>
          在<a href="${pageContext.request.contextPath}/article/detail/{{value.artid}}" target="_blank">{{value.title}}</a>中回答：
          </p>
          <div class="home-dacontent">
          {{value.commcontent}}
          </div>
