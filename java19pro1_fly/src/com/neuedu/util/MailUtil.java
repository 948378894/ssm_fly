...
public class MailUtil {
    ...
    public static String myEmailAccount = "bys952367119@163.com";
    // 此处的密码是第三方授权码，不是邮箱密码
    public static String myEmailPassword = "xiaobai1";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,String mailActiveCode) throws Exception {
        ...
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, "尊敬用户", "UTF-8"));
        // 4. Subject: 邮件主题
        message.setSubject("用户验证", "UTF-8");
        String activeUrl="http://localhost:8080/java19pro1_fiy/user/activemail?mailcode="+mailActiveCode;
        // 5. Content: 邮件正文（可以使用html标签）
        message.setContent("尊敬的用户，您好！Fly社区邀请您点击完成邮箱激活<a href="+activeUrl+" target='_blank'>"+activeUrl+"</a>", "text/html;charset=UTF-8");
        // 6. 设置发件时间
